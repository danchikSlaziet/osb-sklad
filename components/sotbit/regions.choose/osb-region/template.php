...
if($allRegions === false && $USER->isAdmin()){
    ...
    ?>
    <div class="header__change-city overlay change-city">
        <div class="change-city__content">
            <div class="change-city__topbar">
                <span>Выберите город:</span>
                <div class="change-city__close"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/svg/close.svg" alt=""></div>
            </div>
            <ul>
                <?php
                foreach ($arResult['REGION_LIST'] as $i => $region) {
                    ...
                    ?>
                     <li><a class="select-city__modal__list__item" data-index="<?= $i ?>"><?= $region['NAME'] ?></a></li>
                    <?php
                }
                ?>
    ...
    <div class="header__city">
        ...
        <span>г. <?= $arResult['USER_REGION_NAME'] ?></span>
    </div>
