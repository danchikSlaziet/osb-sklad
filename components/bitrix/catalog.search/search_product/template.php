<? if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die();
    ...
    if (Loader::includeModule('search')) {
        ...
        $_REQUEST['q'] = preg_replace('/(\S+)/', '"\\1"', switcher_ru($_REQUEST['q']));
        ...
        if (!empty($arElements) && is_array($arElements)) {
            ...
            if (is_array($arElements)) {
                echo '<div class="search__plug">
                        ...
                        <span>'.GetMessage("CT_BCSE_NOT_FOUND").'</span>
                    </div>';
                return;
            }
        }
    ...
    <?php else: ?>
        <div class="search__plug">
            ...
            <span>Мы готовы начать поиск!</span>
        </div>
    <?php endif; ?>