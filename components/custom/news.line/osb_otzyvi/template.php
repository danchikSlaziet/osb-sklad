...
if (isset($arResult['ELEMENT_ID_NAME']) && !empty($arResult['ELEMENT_ID_NAME'])) {
    $APPLICATION->AddChainItem($arResult['ELEMENT_ID_NAME'], '/product/' . strip_tags($_REQUEST['ELEMENT_CODE']));
